...
**It measured how much of the warehouse the 425 tests actually look at, and the
...
**391 tables against 425 tests**, i.e. 22 orphans, which is the stale-audit-table
