...
**It measured how much of the warehouse the 463 tests actually look at, and the
...
**391 tables against 463 tests**, i.e. 22 orphans, which is the stale-audit-table
