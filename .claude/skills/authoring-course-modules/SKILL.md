...
**It measured how much of the warehouse the 464 tests actually look at, and the
...
**391 tables against 464 tests**, i.e. 22 orphans, which is the stale-audit-table
